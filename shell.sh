...
cd ui/ && git clone  https://$3:$4@github.com/meta-magic/amexio.github.io.git -b $2 >> ui/logs/amexio.log
echo download gulp
cd amexio.github.io/ && npm install gulp && npm install --save del && gulp build  >> ui/logs/amexio.log


echo build  amexio-ng-extensions.tgz  and copying to dir
cd dist && npm pack && mv amexio-ng-extensions-4.1.0.tgz amexio-ng-extensions.tgz && cp amexio-ng-extensions.tgz /var/www/html/desireplatform/amexio-builds/   >> ui/logs/amexio.log
echo clone ui- services
cd ui/ && git clone  https://$3:$4@github.com/meta-magic/dna-ms-ui.git && git clone  https://$3:$4@github.com/meta-magic/codepipeline-ms-ui.git && git clone  https://$3:$4@github.com/meta-magic/auth-ms-ui.git && git clone  https://$3:$4@github.com/meta-magic/user-ms-ui.git && git clone  https://$3:$4@github.com/meta-magic/project-ms-ui.git && git clone  https://$3:$4@github.com/meta-magic/platform-commons.git  >> ui/logs/ui.log
...
cd ui/ && git clone  https://$3:$4@github.com/meta-magic/desire3duishell.git  >> ui/logs/ui.log
echo building desire3duishell
