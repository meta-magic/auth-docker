...
cd ui/ && git clone  https://$2:$3@github.com/meta-magic/amexio.github.io.git -b $1 >> ui/logs/amexio.log
echo download gulp
...
cd ui/ && git clone  https://$2:$3@github.com/meta-magic/dna-ms-ui.git && git clone  https://$2:$3@github.com/meta-magic/codepipeline-ms-ui.git && git clone  https://$2:$3@github.com/meta-magic/auth-ms-ui.git && git clone  https://$2:$3@github.com/meta-magic/user-ms-ui.git && git clone  https://$2:$3@github.com/meta-magic/project-ms-ui.git && git clone  https://$2:$3@github.com/meta-magic/platform-commons.git  >> ui/logs/ui.log
...
cd ui/ && git clone  https://$2:$3@github.com/meta-magic/desire3duishell.git  >> ui/logs/ui.log
echo building desire3duishell
