...
cd /ui/ && git clone  https://$1:$2@github.com/meta-magic/dna-ms-ui.git && git clone  https://$1:$2@github.com/meta-magic/codepipeline-ms-ui.git && git clone  https://$1:$2@github.com/meta-magic/auth-ms-ui.git && git clone  https://$1:$2@github.com/meta-magic/user-ms-ui.git && git clone  https://$1:$2@github.com/meta-magic/project-ms-ui.git && git clone  https://$1:$2@github.com/meta-magic/platform-commons.git 
...
cd /ui/ && git clone  https://$1:$2@github.com/meta-magic/desire3duishell.git 
echo building desire3duishell
